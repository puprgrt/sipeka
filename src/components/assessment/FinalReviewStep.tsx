...
import ComprehensiveAssessmentTable from './ComprehensiveAssessmentTable';
...
<motion.div 
          ...
          >
            ...
            <div className="p-12 flex flex-col items-center relative">
              ...
              <div className="w-full mt-10 mb-6 max-w-[95vw] lg:max-w-full relative left-1/2 -translate-x-1/2 lg:static lg:translate-x-0">
                <ComprehensiveAssessmentTable assessment={{
                  id: "draft",
                  schoolName,
                  buildingName,
                  npsn,
                  ...
                  photos: [],
                  finalResult: {
                    totalDamagePercentage: result.totalDamagePercentage,
