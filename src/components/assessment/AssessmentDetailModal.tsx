        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar text-left">
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm space-y-4">
              ...
              <div className="p-4 rounded-xl border border-emerald-200 bg-gradient-to-r from-emerald-50/70 to-teal-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-sm">
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <p className="font-bold text-xs text-emerald-950">
                        Lampiran Hasil Penilaian Kerusakan (Tipe {selectedAssessment.floorCount === 1 ? 'A - 1 Lantai' : selectedAssessment.floorCount === 2 ? 'B - 2 Lantai' : 'C - 3 Lantai'})
                      </p>
                    ...
                    <p className="text-[10px] text-emerald-700/90 mt-1">
                      Menggunakan Google Drive sebagai Template Repository. 100% format asli, warna, border, dan rumus PUPR utuh.
                    </p>
                  </div>
                </div>
                <div className="flex flex-wrap gap-2">
                  <a
                    href={selectedAssessment.floorCount === 1 
                      ? "https://docs.google.com/spreadsheets/d/1pe2d-T7KzkGqIrXq6bUYoevYI3alXxosT5RBTljvIiE/edit?gid=756257354#gid=756257354"
                      : selectedAssessment.floorCount === 2
                      ? "https://docs.google.com/spreadsheets/d/1sTjY-dIEJI7cDezMpVnb25mcbyHcNrRBe7AFZarz7IA/edit?gid=1536163214#gid=1536163214"
                      : "https://docs.google.com/spreadsheets/d/1bza5jDXLNYtOTyjEsju8e4cv0rZTskBjxsqewIh4dhk/edit?gid=506421235#gid=506421235"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center px-3 py-2 text-xs font-bold rounded-xl text-emerald-700 bg-white border border-emerald-300 hover:bg-emerald-100 shadow-sm transition-all"
                  >
                    Buka Template Asli PUPR
                  </a>
                  <button
                    onClick={() => handleGenerateAnalysisFormat(selectedAssessment)}
                    className="inline-flex items-center px-4 py-2 text-xs font-bold rounded-xl text-white bg-emerald-600 hover:bg-emerald-700 shadow-md transition-all hover:scale-105"
                  >
                    Perbarui Format (Ikuti Template Baru)
                  </button>
                </div>
              </div>
