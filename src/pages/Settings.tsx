...
import { Edit2, Trash2, Plus, Save, X, Info, Camera, HelpCircle, Layers, Users, Phone, Mail, Shield, UserCog, FileText, Printer, UploadCloud, Settings as SettingsIcon, GripVertical, Sun, Moon } from "lucide-react";
...
export default function Settings() {
 ...
 = useState<string>(() => {
  ...
  const getAvailableTabsList = (role: string) => {
    switch (role) {
      case "Administrator":
        return ["aplikasi", "komponen", "katalog", "users", "formulir", "param_profil", "dinas", "surat"];
      case "Kadis":
      case "Kabid":
